...
| `--output <mode>`  | No       | `plain` for deterministic text or `json` for versioned stdout-pure JSONL on task-board flows; omitted by default                |
