...
// fall back to ARCHLOOP_IDLE_TIMEOUT when set, so a single env var can
// still tune both at once. See archloop issue #97.
...
// would duplicate effort. Set ARCHLOOP_NO_PLANNER_RETRY=1 to opt out.
