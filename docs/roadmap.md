...
- [x] 强化 Hub flow lifecycle 与 batch merge preflight：rerun 可复用已有未合并分支 work，transition 后校验 task projection，merge summary 解释 selected/skipped/blocked 原因，并将 `.beads/` runtime/export 文件排除在普通代码分支 merge 之外（见 [#120](https://github.com/Yibeibankaishui/sandcastle/issues/120)、[#121](https://github.com/Yibeibankaishui/sandcastle/issues/121)、[#122](https://github.com/Yibeibankaishui/sandcastle/issues/122)、[#123](https://github.com/Yibeibankaishui/sandcastle/issues/123)、[#124](https://github.com/Yibeibankaishui/sandcastle/issues/124)、[ADR-0027](./adr/0027-hub-beads-runtime-files-stay-local.md)）。
