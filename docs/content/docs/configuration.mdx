---
title: Configuration
description: Configure archLoop for your project.
---

## Config Directory

The `.archloop/` directory in your repository contains all archLoop configuration:
...
The `config.json` file controls how archLoop operates:
...
archLoop resolves environment variables from multiple sources in order:
