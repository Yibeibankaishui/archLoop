...
const runInAuthOnlyContainer = async (
  ...
  const args = [
    ...
    "sh",
    "-v",
    `${process.cwd()}/.sandcastle/auth/codex:/home/agent/.codex`,
    "-v",
    `${process.cwd()}/.sandcastle/auth/cursor:/home/agent/.cursor`,
    "-v",
    `${process.cwd()}/.sandcastle/auth/cursor-config:/home/agent/.config/cursor`,
    "-v",
    `${process.cwd()}/.sandcastle/auth/gh:/home/agent/.config/gh`,
    "-w",
    "/tmp",
