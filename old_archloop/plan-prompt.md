...
For each unblocked issue, assign a branch name using the format `archloop/issue-{number}-{slug}`.
...
<plan>
{"issues": [{"number": 42, "title": "Fix auth bug", "branch": "archloop/issue-42-fix-auth-bug"}]}
</plan>
