...
| `archloop project status`                                               | Show Hub project status and contract summary                            |
| `archloop project configure --project-profile <profile>`                | Create or update the Hub project development contract                   |
