...
| `archloop project relink <project> --path <repo>`                                                                                      | Update a Hub project to a new existing git repo path without changing its stable id.                                                                                                       |
